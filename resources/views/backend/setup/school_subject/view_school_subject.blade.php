                      ...
                      <tbody>
                        @foreach ($allData as $key => $school)
                            <tr>
                                ...
                                <td>{{ $school->name }}</td>
                                <td>
                                    <a href="{{ route('school.subject.edit', ['id' => $school->id]) }}" class="btn btn-info">Edit</a>
                                    <a href="{{ route('school.subject.delete', ['id' => $school->id]) }}" class="btn btn-danger" id="delete">Delete</a>
                                </td>
                            </tr>
                        @endforeach
