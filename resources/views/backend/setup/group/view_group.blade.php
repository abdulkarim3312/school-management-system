                      ...
                      <tbody>
                        @foreach ($allData as $key => $group)
                            <tr>
                                ...
                                <td>{{ $group->name }}</td>
                                <td>
                                    <a href="{{ route('student.group.edit', ['id' => $group->id]) }}" class="btn btn-info">Edit</a>
                                    <a href="{{ route('student.group.delete', ['id' => $group->id]) }}" class="btn btn-danger" id="delete">Delete</a>
                                </td>
                            </tr>
                        @endforeach
